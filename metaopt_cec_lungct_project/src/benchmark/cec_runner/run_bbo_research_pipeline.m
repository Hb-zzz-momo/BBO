...
function paths = resolve_pipeline_paths()
    ...
    paths.compare_file = fullfile(paths.repo_root, 'src', 'benchmark', 'cec_runner', 'run_compare_sbo_bbo.m');
    paths.bbo_2017 = fullfile(paths.repo_root, 'src', 'baselines', 'metaheuristics', 'BBO', ...
        'Source_code_BBO_MATLAB_VERSION_extracted', 'Source_code_BBO_MATLAB_VERSION', 'CEC2017', 'BBO.m');
    paths.bbo_2022 = fullfile(paths.repo_root, 'src', 'baselines', 'metaheuristics', 'BBO', ...
        'Source_code_BBO_MATLAB_VERSION_extracted', 'Source_code_BBO_MATLAB_VERSION', 'CEC2022', 'BBO.m');
    paths.cec2017_getter = fullfile(paths.repo_root, 'src', 'baselines', 'metaheuristics', 'BBO', ...
        'Source_code_BBO_MATLAB_VERSION_extracted', 'Source_code_BBO_MATLAB_VERSION', 'CEC2017', 'Get_Functions_cec2017.m');
    paths.cec2022_getter = fullfile(paths.repo_root, 'src', 'baselines', 'metaheuristics', 'BBO', ...
        'Source_code_BBO_MATLAB_VERSION_extracted', 'Source_code_BBO_MATLAB_VERSION', 'CEC2022', 'Get_Functions_cec2022.m');
    paths.improved_root = fullfile(paths.repo_root, 'src', 'improved', 'algorithms', 'BBO');
end
...
function write_analysis_markdown(file_path, report, cfg)
    ...
    fprintf(fid, '- run_all_compare exists: %d\n', report.scan.files.run_all_compare);
    ...
    fprintf(fid, '- Reuse run_all_compare as the single benchmark backend.\n');
    ...
    fprintf(fid, '- Failure cases are preserved through run_all_compare logs and summaries.\n');
end
