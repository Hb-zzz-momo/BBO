function [best_fitness, best_solution, Convergence_curve] = BBO_route_a_differential_generator_bbo(N, Max_iteration, lb, ub, dim, fobj)
% BBO_route_a_differential_generator_bbo
% Route A: BBO + Differential Main Generator.
% Design:
% 1) Keep BBO update as one main candidate generator.
% 2) Add DE mutation+crossover as another main candidate generator.
% 3) Two candidates compete; winner competes with incumbent.
%
% Core parameters (minimal set):
% - F_max = 0.8, F_min = 0.4 : differential scaling schedule.
% - CR_max = 0.9, CR_min = 0.55 : late-stage shrinking crossover schedule.
% - beta_best = 0.2           : current-to-best directional gain.
    ...
    for t = 1:Max_iteration
        ...
        for i = 1:N
            ...
            % Main line 2: DE candidate (current-to-best + binomial crossover).
