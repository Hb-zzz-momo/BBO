function [best_fitness, best_solution, Convergence_curve] = BBO_route_a_gated_bbo(N, Max_iteration, lb, ub, dim, fobj)
% BBO_route_a_gated_bbo
% A_gated: add gated activation for differential candidate.
% Boundary: no p-best reference, no safe acceptance.
    ...
    for t = 1:Max_iteration
        ...
        for i = 1:N
            ...
            if rand < gate_prob
                ...
                F_eff = gate_scale * F;
                donor = xi + beta_best * (best_solution - xi) + F_eff * (population(r1, :) - population(r2, :)) ...
