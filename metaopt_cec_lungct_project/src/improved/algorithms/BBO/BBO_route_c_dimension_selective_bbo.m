function [best_fitness, best_solution, Convergence_curve] = BBO_route_c_dimension_selective_bbo(N, Max_iteration, lb, ub, dim, fobj)
% BBO_route_c_dimension_selective_bbo
% Route C minimal prototype:
% fixed-ratio dimension-selective SEL, no GDP/ESC.

    runtime_cfg = struct( ...
        'mode', 'v1_full', ...
        'enable_selective_elite_learning', true, ...
        'enable_gated_directional_push', false, ...
        'enable_anti_stagnation_escape', false, ...
        'sel_dim_ratio_early', 0.18, ...
        'sel_dim_ratio_late', 0.18, ...
        'sel_topk_ratio', 0.20, ...
        'sel_apply_prob', 0.50);
