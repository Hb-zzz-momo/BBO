function [best_fitness, best_solution, Convergence_curve] = BBO_route_a_budget_adaptive_archive_only_bbo(N, Max_iteration, lb, ub, dim, fobj)
% BBO_route_a_budget_adaptive_archive_only_bbo
% Layered ablation entry: baseline + archive.

    ensure_module_paths();

    cfg = struct();
    cfg.algorithm_entry = 'BBO_route_a_budget_adaptive_archive_only_bbo';
