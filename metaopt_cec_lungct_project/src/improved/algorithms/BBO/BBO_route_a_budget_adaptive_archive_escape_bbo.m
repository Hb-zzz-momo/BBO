function [best_fitness, best_solution, Convergence_curve] = BBO_route_a_budget_adaptive_archive_escape_bbo(N, Max_iteration, lb, ub, dim, fobj)
% BBO_route_a_budget_adaptive_archive_escape_bbo
% Version C: budget-adaptive Route A + lightweight archive + stagnation-triggered jumps.
