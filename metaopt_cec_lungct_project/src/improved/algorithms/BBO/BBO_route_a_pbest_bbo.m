function [best_fitness, best_solution, Convergence_curve] = BBO_route_a_pbest_bbo(N, Max_iteration, lb, ub, dim, fobj)
% BBO_route_a_pbest_bbo
% A_pbest: replace single-best reference with p-best elite reference.
% Boundary: no gated activation, no safe acceptance.
    ...
    for t = 1:Max_iteration
        ...
        for i = 1:N
            ...
            donor = xi + beta_best * (pbest_ref - xi) + F * (population(r1, :) - population(r2, :)) ...
