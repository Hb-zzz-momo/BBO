...
import sys, inspect
from .mdm_group import (HGS, INFO, PLO, RIME, RUN, SBO, SMA)
from .bio_based import (BBO, BBOA, BMO, EOA, IWO, SOA, SOS, TPO, TSA, VCS, WHO)
from .bio_based import (BBO, BBOA, BMO, EOA, IWO, SOA, SOS, TPO, TSA, VCS, WHO)
...
from .math_based import (AOA, CEM, CGO, CircleSA, GBO, HC, PSS, SCA, SHIO, TS)
from .physics_based import (ArchOA, ASO, CDO, EFO, EO, EVO, FLA, HGSO, MVO, NRO, SA, TWO, WDO)
from .swarm_based import (ABC, ACOR, AGTO, ALO, AO, ARO, AVOA, BA, BeesA, BES, BFO, BSA, COA, CoatiOA, CSA, CSO,
                          DMOA, DO, EHO, ESOA, FA, FFA, FFO, FOA, FOX, GJO, GOA, GTO, GWO, HBA, HHO, JA,
